...
- 這是 Obsidian 筆記庫：行文首次提到本章條目時用 wiki-link 連結，用詞不同寫 [[完整條目名|行文用詞]]，之後再提不必重連；至少要有一個連結，且目標只能取自本章可連條目：摩西、亞倫、以他瑪、革順子孫、米拉利子孫、哥轄子孫、燔祭、贖罪祭、平安祭、素祭（minchah）、施恩座、二基路伯中間說話的聲音（施恩座微聲）、奉獻壇之禮（十二支派首領奉獻）、奉獻篷車與牛（利未人搬運分工）、拿順、按日獻供物（十二天奉獻禮）、聖所的平（捨客勒標準）、肩頭抬聖物（哥轄子孫）、金盂盛滿了香（祈禱與事奉）——不可連清單外的目標；清單裡沒有對應條目的概念（vault 裡存在與否都一樣），直接用純文字提及即可，不要加 [[ ]]。
