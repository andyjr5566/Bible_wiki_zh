...
- 這是 Obsidian 筆記庫：行文首次提到本章條目時用 wiki-link 連結，用詞不同寫 [[完整條目名|行文用詞]]，之後再提不必重連；至少要有一個連結，且目標只能取自本章可連條目：無殘疾與未曾負軛的紅母牛、除污穢的水、向會幕前彈紅母牛的血七次、香柏木、牛膝草與朱紅線、第三日與第七日的除污穢禮儀、玷污耶和華的聖所與帳幕、營外焚燒、牛膝草、香柏木（潔淨儀式用）、活水（潔淨儀式用）、死屍不潔、第三日、剪除——不可連清單外的目標；清單裡沒有對應條目的概念（vault 裡存在與否都一樣），直接用純文字提及即可，不要加 [[ ]]。
