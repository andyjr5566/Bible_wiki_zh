...
- path: raw_data/ccbiblestudy_CT_joshua_3.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/06Josh/06CT03.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 拾穗（ccbiblestudy GT）
- path: raw_data/ccbiblestudy_GT_joshua_3.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/06Josh/06GT03.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 研經註解（KingComments）
- path: raw_data/kingcomments_joshua_3.txt
- url: https://www.kingcomments.com/en/bible-studies/Jos/3
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 研經註解（BibleHub Study）
- path: raw_data/biblehub_study_joshua_3.txt
- url: https://biblehub.com/study/joshua/3.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

## Structured original-language source

### 原文資料（STEP Bible）
- path: raw_data/stepbible_joshua_3.txt
