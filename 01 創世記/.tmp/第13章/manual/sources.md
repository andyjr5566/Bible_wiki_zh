...
### 研經註解（BibleHub Study）
- path: raw_data/biblehub_study_genesis_13.txt
- url: https://biblehub.com/study/genesis/13.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 研經註解（KingComments）
- path: raw_data/kingcomments_genesis_13.txt
- url: https://www.kingcomments.com/en/bible-studies/Gen/13
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 逐節註解（ccbiblestudy CT）
- path: raw_data/ccbiblestudy_CT_genesis_13.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/01Gen/01CT13.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 拾穗（ccbiblestudy GT）
- path: raw_data/ccbiblestudy_GT_genesis_13.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/01Gen/01GT13.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

## Structured original-language source

### 原文資料（STEP Bible）
- path: raw_data/stepbible_genesis_13.txt
