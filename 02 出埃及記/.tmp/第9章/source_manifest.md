# 出埃及記 第9章 source manifest

| 來源 | 類型 | URL | raw_data 檔案 | 狀態 |
|---|---|---|---|---|
| ccbiblestudy | CT | https://www.ccbiblestudy.org/Old%20Testament/02Exodus/09CT01.htm | raw_data/ccbiblestudy_CT_exodus_9.txt | OK |
...
- 涵蓋範圍：畜疫之災(1-7)、瘡災(8-12)、雹災(13-35)，含法老首次承認「我犯了罪」及神宣告「叫你存立、顯大能、傳遍天下」的核心經文。

## 體例與用詞對照

| 來源 | 簡稱 | 體例 |
|---|---|---|
| ccbiblestudy 註解 | CT | 逐節「原文字義／文意註解／話中之光」格式 |
| ccbiblestudy 拾穗 | GT | 多家註冊串珠，含較長之文化背景與經文辯證 |
| KingComments | KC | 分段並附解經應用與聖經互文 |
| BibleHub Study | BH | 多節分段之字面與神學註解 |
