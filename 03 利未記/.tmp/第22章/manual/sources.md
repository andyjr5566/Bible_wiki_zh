...
- path: raw_data/ccbiblestudy_CT_leviticus_22.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/03Lev/03CT22.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 拾穗（ccbiblestudy GT）
- path: raw_data/ccbiblestudy_GT_leviticus_22.txt
- url: https://www.ccbiblestudy.org/Old%20Testament/03Lev/03GT22.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 研經註解（KingComments）
- path: raw_data/kingcomments_leviticus_22.txt
- url: https://www.kingcomments.com/en/bible-studies/Lev/22
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

### 研經註解（BibleHub Study）
- path: raw_data/biblehub_study_leviticus_22.txt
- url: https://biblehub.com/study/leviticus/22.htm
- validation: human/agent full-read receipt（3 段逐字引句，至少 1 段在後 1/3）

## Structured original-language source

### 原文資料（STEP Bible）
- path: raw_data/stepbible_leviticus_22.txt
