...
#### 第26章
- 本章重點：本章記載皂莢木用於製作帳幕豎板（v15）、橫閂（v26）、內幔柱子（v32）與門簾柱子（v37），皆包裹金子，並用金環套閂連結（v29）。
- 與本章關聯：皂莢木在本章從出25章約櫃、桌子、燈臺等器具的材料，延伸為帳幕本身的結構骨架（豎板、閂）與內幔、門簾的柱子，顯明基督堅固人性不僅是器具的根基，更是整個帳幕結構得以站立的基礎。
