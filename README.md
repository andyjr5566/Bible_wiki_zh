...
第一次使用建議先在電腦上完成安裝，確認 Vault 可正常開啟後，再設定手機同步。
...
| [內容編寫規則](scheme.md) | 專案架構、格式與維護流程 |
| [AI 協作提示](agent_start_prompt.md) | 使用 AI 協助維護內容的起始說明 |
| [GitHub 專案](https://github.com/andyjr5566/Bible_wiki_zh) | 下載、Fork 與查看更新 |
